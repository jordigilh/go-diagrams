...
func (u *unixNode) Flotta(opts ...diagram.NodeOption) *diagram.Node {
	nopts := diagram.MergeOptionSets(diagram.OptionSet{diagram.Icon("../assets/linux/flotta.png")}, u.opts, opts)
	return diagram.NewNode(nopts...)
}
